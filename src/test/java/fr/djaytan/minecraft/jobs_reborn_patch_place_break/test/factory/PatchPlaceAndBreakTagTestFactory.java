...
public final class PatchPlaceAndBreakTagTestFactory {
  ...
  public static final TagLocation TAG_LOCATION = TagLocationTestFactory.create();

  private PatchPlaceAndBreakTagTestFactory() {
    // Static class
  }
